...
const Navbar = () => {
  ...
  return (
    <>
      {/* for large screen */}
      <div className='hidden md:hidden lg:flex sticky top-0 w-full z-50 bg-white px-10 xl:px-16 shadow-md  justify-between items-center py-3 '>
        ...
        <ul className='flex gap-8 xl:gap-10 items-center text-gray-800 font-semibold text-sm '>
          <li
          ...
          >
            ...
            <WomenModal open={womenModal} onClose={() => setWomenModal(false)} />
          </li>
        ...
        >
          <input
            ...
            className="xl:w-[450px]  px-10 py-2 bg-gray-100 outline-none rounded"
          />
          <IoMdSearch className="absolute top-3 left-3 text-gray-500" />
        ...
        <div className='flex gap-8 xl:gap-10 items-center cursor-pointer'>
          ...
          <div className='relative flex flex-col items-center justify-center cursor-pointer'
            ...
            {wishlistItem.length > 0 && (<div className='absolute bg-red-600 h-3 w-3 p-2 flex items-center justify-center rounded-full text-white -top-1 right-0 text-xs'>{wishlistItem.length}</div>)}
          ...
          <div className='flex flex-col items-center justify-center cursor-pointer relative'
            ...
            {cartItems.length > 0 && (<div className='absolute bg-red-600 h-3 w-3 p-2 flex items-center justify-center rounded-full text-white top-0 -right-2 text-xs'>{cartItems.length}</div>)}
